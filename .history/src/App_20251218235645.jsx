    ...
    <div className="page">
      ...
      <section className="scroll-section">
        ...
        <section id="contact" className="content-section">
          <h2>About</h2>
          <p>
            Feel free to reach out to me via email at <a href="mailto:sosaiah@outlook.com">sosaiah@outlook.com</a>.
          </p>
          <p>You can also find me on <a href="https://www.linkedin.com/in/sosaiah-hillier-barnes-0000000000/">LinkedIn</a>.</p>
        </section>
